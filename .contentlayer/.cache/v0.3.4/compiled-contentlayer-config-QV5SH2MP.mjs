    ...
    normalizedTags: {
      ...
      resolve: (doc) => {
        ...
        if (!Array.isArray(tags))
          return [];
        return tags.map((t) => String(t).toLowerCase().trim()).filter((t) => TAGS.includes(t)).filter((v, i, a) => a.indexOf(v) === i).sort();
      }
    },
    isValid: {
      type: "boolean",
...
//# sourceMappingURL=compiled-contentlayer-config-QV5SH2MP.mjs.map
